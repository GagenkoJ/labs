...
namespace MageBattle
{
    ...
    public class FireMage : Mage
    {
        ...
        {
            Console.WriteLine($"{Name} атакує {target.Name} використовуючи {spell.Name}!");
    ...
    public class Fireball : ISpell
    {
        ...
        public void Cast(Mage caster, Mage target)
        {
            ...
            Console.WriteLine($"{target.Name} отримує {damage} шкоди від {Name}!");
    ...
    public class FireShield : ISpell
    {
        ...
        public void Cast(Mage caster, Mage target)
        {
            ...
            Console.WriteLine($"{caster.Name} захищений на {shield} від {Name}!");
